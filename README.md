...
- **Multilingual** — 11 translations included: English, Dutch, German, Spanish, French, Portuguese, Italian, Russian, Polish, Japanese, and Chinese Simplified
...
11 translations are included out of the box: English (`en`), Dutch (`nl`), German (`de`), Spanish (`es`), French (`fr`), Portuguese (`pt`), Italian (`it`), Russian (`ru`), Polish (`pl`), Japanese (`ja`), and Chinese Simplified (`zh`). Publish them to customize the error messages:
